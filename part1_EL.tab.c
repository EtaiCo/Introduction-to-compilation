...
{
       0,   128,   128,   136,   137,   143,   153,   230,   289,   293,
     294,   299,   300,   304,   319,   320,   321,   322,   323,   324,
     325,   326,   331,   335,   339,   344,   353,   355,   361,   362,
     363,   364,   365,   366,   368,   372,   374,   378,   379,   384,
     417,   419,   420,   426,   427,   428,   429,   430,   431,   432,
     433,   434,   435,   441,   469,   482,   498,   520,   543,   544,
     548,   557,   566,   575,   586,   596,   607,   609,   615,   630,
     638,   643,   648,   653,   663,   672,   720,   721,   727,   730,
     733,   736,   740,   751,   752,   753,   754,   757,   758,   780,
     782,   800,   813,   814,   819,   820,   821,   822,   823,   824,
     828,   854,   855,   857,   858,   859,   864
};
#endif
...
#line 1467 "part1_EL.tab.c"
    break;

  case 4: /* functions: function  */
#line 137 "part1_EL.y"
                                             { (yyval.nodePtr) = (yyvsp[0].nodePtr); }
#line 1473 "part1_EL.tab.c"
    break;
