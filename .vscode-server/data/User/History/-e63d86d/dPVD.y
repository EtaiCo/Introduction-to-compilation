...
%{
    ...
    typedef struct CodeFrag {
        char *place;     /* the temp/register holding this value            */
        Instr *start;   
    } CodeFrag;
    ...
    /* ===== 3AC support ===== */
    typedef struct Instr {            /* one TAC instruction          */
        char *text;                   /* e.g.  "t1 = a + b"           */
        struct Instr *next;
    } Instr;
    ...
    {
        va_list ap;  Instr *n = malloc(sizeof(Instr));
        char buf[128];
