...
%type <nodePtr> param var dec_list dec type literal idents idents_list ident_entry
...
ident_entry :
 ...
 | IDENT '[' INT_LIT ']' ':' STRING_LIT
      {
          char lenBuf[32];                     /* turn the int into text   */
          sprintf(lenBuf, "%d", $3);
          ...
          $$ = mknode("ARRAY_INIT",
                      mknode("ARRAY_DECL",
                             mknode("IDENT",
                                    mknode($1, NULL, NULL),
                                    NULL),
                             mknode(lenBuf, NULL, NULL)),   /* <- SAFE */
                      mknode($6, NULL, NULL));              /* "moshe" */
      }
