...
/* size (in bytes) of the value that will live in a temporary */
static int resultSize(node *e) { return sizeofType(inferExprType(e)); }

/* create temp for expression e and add its size to the function’s total */
static char *makeTempFor(node *e)
{
