...
function :
    DEF IDENT { currentFunc = $2; } '(' params ')' ':' RETURNS type var scope_marker T_BEGIN statements END
    {
  ...
  | DEF IDENT { currentFunc = $2; } '(' params ')' ':' var scope_marker T_BEGIN statements END
    {
        if (moreThanOneMain($2)) YYABORT;
